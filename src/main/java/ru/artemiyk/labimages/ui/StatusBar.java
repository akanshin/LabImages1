...
public class StatusBar extends JPanel {
  ...
  public void setCIELAB(PixelCIELAB cieLab) {
    valueLAB.setText(String.format("LAB: (%d, %d, %d)", (int) cieLab.getL(), (int) cieLab.getA(), (int) cieLab.getB()));
  }

  public void setMousePoint(int mouseX, int mouseY) {
    mouseValue.setText(String.format("Cursor: %dx%d", mouseX, mouseY));
  }

  public void setSelectedPoint(int pointX, int pointY) {
    selectionValue.setText(String.format("p: %dx%d", pointX, pointY));
  }

  public void setSelection(int x1, int y1, int x2, int y2) {
    selectionValue.setText(String.format("s: %dx%d - %dx%d", x1, y1, x2, y2));
  }
