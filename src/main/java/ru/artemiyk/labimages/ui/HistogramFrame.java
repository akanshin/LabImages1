  ...
  public void showHistogram() {
    ...
    thread1 = new Thread() {
      public void run() {
        ...
        JFreeChart jfChartL = ChartFactory.createHistogram("", "", "", jfDatasetL, PlotOrientation.VERTICAL, true, true,
            true);
    ...
    thread2 = new Thread() {
      public void run() {
        ...
        JFreeChart jfChartA = ChartFactory.createHistogram("", "", "", jfDatasetA, PlotOrientation.VERTICAL, true, true,
            false);
    ...
    thread3 = new Thread() {
      public void run() {
        ...
        JFreeChart jfChartB = ChartFactory.createHistogram("", "", "", jfDatasetB, PlotOrientation.VERTICAL, true, true,
            false);
